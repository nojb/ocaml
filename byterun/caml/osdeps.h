...
extern int caml_read_directory(_TCHAR * dirname, struct ext_table * contents);
...
*/
extern _TCHAR* caml_stat_strdup_to_utf16(const char *s);
...
/* [caml_stat_strdup_of_utf16(s)] returns a NULL-terminated copy of [s],
   ...
   using [caml_stat_free].
*/
extern char* caml_stat_strdup_of_utf16(const _TCHAR *s);
...
*/
extern value caml_copy_string_of_utf16(const _TCHAR *s);
