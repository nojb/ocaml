...
value caml_startup_common(_TCHAR **argv, int pooling)
{
  _TCHAR * exe_name, * proc_self_exe;
  char tos;
...
value caml_startup_exn(_TCHAR **argv)
{
  return caml_startup_common(argv, /* pooling */ 0);
}

void caml_startup(_TCHAR **argv)
{
...
void caml_main(_TCHAR **argv)
{
  caml_startup(argv);
}

value caml_startup_pooled_exn(_TCHAR **argv)
{
  return caml_startup_common(argv, /* pooling */ 1);
}

void caml_startup_pooled(_TCHAR **argv)
{
